...
public class NetworkPlayer : NetworkBehaviour
{
    ...
    private void Update()
    {
        ...
        if (VRRigReference.Singleton.root == null) return;
        if (VRRigReference.Singleton.head == null) return;
        if (VRRigReference.Singleton.leftHand == null) return;
        if (VRRigReference.Singleton.rightHand == null) return;
